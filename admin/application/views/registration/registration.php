...
<head>
    ...
    <script src="<?php echo base_url('assets/js/registrationjs.js') ?>"></script>
</head>
                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="post">
                            <div class="form-floating mb-3">
                                <input type="text" id="username" name="username" class="form-control" placeholder="jhondoe">
                                <label for="floatingText">Username</label>
                            </div>
                            <span class="text-danger" id="usernamevalidation">Username must be required.</span>
                            <div class="form-floating mb-3">
                            ...
                            <input type="submit" id="regbtn" class="btn btn-primary py-3 w-100 mb-4" value="Sign Up">
