...
|
*/
$config['base_url'] = 'http://localhost/eduniversity/admin/';
...
$config['sess_driver'] = 'files'; // Use 'files' for file-based sessions
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = 7200; // Session expiration time in seconds
$config['sess_save_path'] = sys_get_temp_dir(); // Path where sessions are saved, ensure this is writable
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
